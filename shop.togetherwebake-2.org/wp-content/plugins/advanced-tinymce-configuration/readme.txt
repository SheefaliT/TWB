...
Set advanced options for TinyMCE, the WordPress WYSIWYG editor.

== Description ==

This plugin is intended for more advanced users that would like to change the default TinyMCE configuration in WordPress. 
It makes it very easy to add, remove or change all TinyMCE settings for both the Classic (TinyMCE) Editor and for the Classic BLock in the Block Editor.
...
= 1.3 =
Added "How-to", example screenshots, and updated the help.
