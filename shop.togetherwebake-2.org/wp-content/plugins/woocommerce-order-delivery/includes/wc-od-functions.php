 ...
 * @return string|false The localized time string. False otherwise.
 */
function wc_od_localize_time( $time, $format = null ) {
	...
	return date( $format, wc_od_get_timestamp( $time ) );
}
...
function wc_od_enqueue_datepicker( $context = '' ) {
	wp_enqueue_style( 'bootstrap-datepicker', WC_OD_URL . 'assets/css/lib/bootstrap-datepicker.css', array(), '1.7.1' );
	wp_add_inline_style( 'bootstrap-datepicker', wc_od_get_datepicker_custom_styles( $context ) );

	wp_enqueue_script( 'bootstrap-datepicker', WC_OD_URL . 'assets/js/lib/bootstrap-datepicker/bootstrap-datepicker.min.js', array( 'jquery' ), '1.7.1', true );

	$datepicker_locale = wc_od_get_datepicker_locale_url();
	if ( $datepicker_locale ) {
		wp_enqueue_script( 'bootstrap-datepicker-l10n', $datepicker_locale, array( 'jquery', 'bootstrap-datepicker' ), '1.7.1', true );
	}
