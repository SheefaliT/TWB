...
<div id="wc-od">
	...
	<?php elseif ( isset( $shipping_date ) ) : ?>
		...
		<p>
			...
			printf( wp_kses_post( __( '', 'woocommerce-order-delivery' ) ), "<strong>{$shipping_date}</strong>" ); // WPCS: XSS ok.
			?>
		</p>
	...
	<p>All shipped orders with Cookies are shipped on the following Tuesday.</p>
