...
<div style="margin-bottom: 40px;">
	...
	<?php
		...
		printf( wp_kses_post( __( 'Our goal is to have your order for Pickup or Shipping ready on %s.', 'woocommerce-order-delivery' ) ), "<strong>{$delivery_date}</strong>" ); // WPCS: XSS ok.
	?>
	</p>
